...
int main(int argc, const char * argv[])
{
 ...
 //   addrShNbAgent=0;
    ...
    *((strucPidPartage*)addrPidMainProc) = sPP;
    ...
    strucNbAg sNbA;
    if ((shIdNbAgent = shmget(KEYNBAGENT, 6*sizeof(strucNbAg), 0777 | IPC_CREAT)) < 0)
...
//                    sNbA2.nbAg=sNbA2.nbAg+1;
  ...
  //                  *((strucNbAg *)addrShNbAgent) = sNbA2;
                    ...
                    printf("NUMERO DANS MAIN %d !!!!!! %d \n",((strucNbAg *)addrShNbAgent)->nbAg,((struct Agent *)addrShAgent)[((strucNbAg *)addrShNbAgent)->nbAg].numero);
