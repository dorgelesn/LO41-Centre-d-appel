...
//    printf(" test %d \n ",agtest->numero);
    ...
    for(i=0; i<6; ++i)
    {
        ...
        if((ag[i].langue==2&&ag[i].groupe==0)|| (ag[i].langue==1 && langue==1&&ag[i].groupe==0) || (ag[i].langue==2 && langue==0&&ag[i].groupe==0)
            || (ag[i].langue==2&&ag[i].groupe==1&&probleme==1) || (ag[i].langue==1 && langue==1&&ag[i].groupe==1&&probleme==1) || (ag[i].langue==2 && (langue==0)&&ag[i].groupe==1&&probleme==1))
        {
